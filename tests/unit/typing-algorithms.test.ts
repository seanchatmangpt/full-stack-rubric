...
// Mock typing session data structure
...
class TypingCalculator {
   ...
   */
  static calculateWPM(session: TypingSession): number {
   ...
   */
  static calculateAccuracy(session: TypingSession): number {
   ...
   */
  static calculateRealtimeWPM(keystrokes: KeystrokeEvent[], currentTime: number): number {
   ...
   */
  static calculateConsistency(keystrokes: KeystrokeEvent[]): number {
   ...
   */
  static detectTypingBursts(keystrokes: KeystrokeEvent[], burstThreshold = 100): number {
    let burstCount = 0
...
describe('TypingCalculator', () => {
  ...
  describe('calculateRealtimeWPM', () => {
    let mockKeystrokes: KeystrokeEvent[]
...
describe('TypingCalculator Performance', () => {
  it('should calculate WPM for large sessions efficiently', () => {
    const largeSession: TypingSession = {
